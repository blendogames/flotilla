...
struct VertexPosNormTexBump : IVertexType
{
...
class SphereMesh : IDisposable
{
    ...
    public void LoadContent(Game game)
    {
        ...
        elements[1] = new VertexElement(12, VertexElementFormat.Vector3, VertexElementUsage.Normal, 0);
        elements[2] = new VertexElement(24, VertexElementFormat.Vector3, VertexElementUsage.Tangent, 0);
        elements[3] = new VertexElement(36, VertexElementFormat.Vector3, VertexElementUsage.Binormal, 0);
        elements[4] = new VertexElement(48, VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 0);
