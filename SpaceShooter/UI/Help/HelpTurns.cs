...
{
    public class HelpTurns : SysMenu
    {
        int WINDOWWIDTH = 900;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Helpers.DrawOutline(FrameworkCore.Gothic, Resource.HelpTurns, titlePos, titleColor, darkColor,
                0, Vector2.Zero, 1);
            ...
            FrameworkCore.SpriteBatch.DrawString(FrameworkCore.SerifBig, Resource.HelpTurnsOrdersTitle, titlePos,
                phaseColor, 0, Vector2.Zero, 0.9f, SpriteEffects.None, 0);
            FrameworkCore.SpriteBatch.DrawString(FrameworkCore.SerifBig, Resource.HelpTurnsActionTitle,
                titlePos + offset,
                phaseColor, 0, Vector2.Zero, 0.9f, SpriteEffects.None, 0);
        ...
        {
            descTxt = Helpers.StringWrap(FrameworkCore.Serif, Resource.HelpTurnsDescription, WINDOWWIDTH);
            descAction = Helpers.StringWrap(FrameworkCore.Serif, Resource.HelpTurnsOrders, WINDOWWIDTH/2 - 10);
            descOrder = Helpers.StringWrap(FrameworkCore.Serif, Resource.HelpTurnsAction, WINDOWWIDTH/2 - 10);
