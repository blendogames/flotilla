...
namespace SpaceShooter
{
    ...
    public class ParticleEmitter
    {
        ...
        /// </summary>
        public ParticleEmitter(float particlesPerSecond, Vector3 initialPosition, params ParticleSystem[] particleSystems)
        {
            this.particleSystems = new List<ParticleSystem>();
            for (int i = 0; i < particleSystems.Length; ++i)
                this.particleSystems.Add(particleSystems[i]);
            ...
            if (elapsedTime > 0)
            {
                ...
                while (timeToSpend > timeBetweenParticles)
                {
                    ...
                    for (int i = 0; i < particleSystems.Count; ++i)
                        particleSystems[i].AddParticle(position, velocity);
                }
